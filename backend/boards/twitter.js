...
const {
    ...
    BOT_CONSUMER_SECRET,
    BOT_ACESS_TOKEN,
    BOT_ACESS_TOKEN_SECRET
} = require('../config')

const Tweet = new Twitter({
    consumer_key: BOT_CONSUMER_KEY,
    consumer_secret: BOT_CONSUMER_SECRET,
    access_token_key: BOT_ACESS_TOKEN,
    access_token_secret: BOT_ACESS_TOKEN_SECRET,
})
 ...
 * 
 * @param {*} tag : ex.: bot
 * https://dev.to/devmaktubi/como-fazer-o-seu-proprio-bot-de-twitter-20i
 */
function startTwitterBot(tag) {
    var stream = Tweet.stream('statuses/filter', { track: tag })
